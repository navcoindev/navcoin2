...
QT_MOC_LITERAL(8, 131, 29)
    ...
    "anonsendRoundsChanged\0"
    "anonymizeNavCoinAmountChanged\0"
};
...
void OptionsModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->anonsendRoundsChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 5: _t->anonymizeNavCoinAmountChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (OptionsModel::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OptionsModel::anonsendRoundsChanged)) {
                *result = 4;
            }
        }
        {
            typedef void (OptionsModel::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OptionsModel::anonymizeNavCoinAmountChanged)) {
                *result = 5;
            }
        }
    }
...
// SIGNAL 4
void OptionsModel::anonsendRoundsChanged(int _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 5
void OptionsModel::anonymizeNavCoinAmountChanged(int _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
