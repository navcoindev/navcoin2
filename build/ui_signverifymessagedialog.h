...
"}"));
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/icons/copy-white"), QSize(), QIcon::Normal, QIcon::Off);
...
"}"));
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/icons/edit-white"), QSize(), QIcon::Normal, QIcon::Off);
...
"}"));
    ...
    void retranslateUi(QDialog *SignVerifyMessageDialog)
    {
        ...
        addressIn_SM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "The address to sign the message with (e.g. NSC5wYyficJm8kh2YxwsFM2bGr4FUgz4vP)", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        addressIn_VM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "The address the message was signed with (e.g. NSC5wYyficJm8kh2YxwsFM2bGr4FUgz4vP)", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
