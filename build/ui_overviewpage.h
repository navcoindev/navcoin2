...
public:
    ...
    QFrame *frameAnonsend;
    QWidget *verticalLayoutWidget;
    QVBoxLayout *verticalLayout_5;
    QFormLayout *formLayout;
    QLabel *label_61;
    QLabel *anonsendEnabled;
    QLabel *label_7;
    QProgressBar *anonsendProgress;
    ...
    QLabel *anonsendStatus;
    QHBoxLayout *horizontalLayout_2;
    QPushButton *toggleAnonsend;
    QPushButton *anonsendReset;
    QPushButton *anonsendAuto;
...
""));
        ...
        frameAnonsend = new QFrame(scrollAreaWidgetContents);
        frameAnonsend->setObjectName(QStringLiteral("frameAnonsend"));
        QSizePolicy sizePolicy(QSizePolicy::MinimumExpanding, QSizePolicy::MinimumExpanding);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(frameAnonsend->sizePolicy().hasHeightForWidth());
        frameAnonsend->setSizePolicy(sizePolicy);
        frameAnonsend->setMinimumSize(QSize(300, 261));
        frameAnonsend->setStyleSheet(QStringLiteral("background:transparent;"));
        frameAnonsend->setFrameShape(QFrame::StyledPanel);
        frameAnonsend->setFrameShadow(QFrame::Raised);
        verticalLayoutWidget = new QWidget(frameAnonsend);
        ...
        anonsendEnabled = new QLabel(verticalLayoutWidget);
        anonsendEnabled->setObjectName(QStringLiteral("anonsendEnabled"));
        anonsendEnabled->setStyleSheet(QStringLiteral("color: rgb(0, 0, 0);"));

        formLayout->setWidget(0, QFormLayout::FieldRole, anonsendEnabled);
        ...
        anonsendProgress = new QProgressBar(verticalLayoutWidget);
        anonsendProgress->setObjectName(QStringLiteral("anonsendProgress"));
        anonsendProgress->setMaximumSize(QSize(154, 16777215));
        anonsendProgress->setStyleSheet(QStringLiteral("background:transparent;"));
        anonsendProgress->setValue(0);

        formLayout->setWidget(1, QFormLayout::FieldRole, anonsendProgress);
        ...
        anonsendStatus = new QLabel(verticalLayoutWidget);
        anonsendStatus->setObjectName(QStringLiteral("anonsendStatus"));
        anonsendStatus->setMinimumSize(QSize(288, 43));
        anonsendStatus->setStyleSheet(QStringLiteral("color: rgb(0, 0, 0);"));
        anonsendStatus->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignTop);
        anonsendStatus->setWordWrap(true);

        verticalLayout_5->addWidget(anonsendStatus);

        horizontalLayout_2 = new QHBoxLayout();
        horizontalLayout_2->setObjectName(QStringLiteral("horizontalLayout_2"));
        toggleAnonsend = new QPushButton(verticalLayoutWidget);
        toggleAnonsend->setObjectName(QStringLiteral("toggleAnonsend"));
        QSizePolicy sizePolicy1(QSizePolicy::MinimumExpanding, QSizePolicy::Fixed);
        sizePolicy1.setHorizontalStretch(0);
        sizePolicy1.setVerticalStretch(0);
        sizePolicy1.setHeightForWidth(toggleAnonsend->sizePolicy().hasHeightForWidth());
        toggleAnonsend->setSizePolicy(sizePolicy1);
        toggleAnonsend->setStyleSheet(QStringLiteral("color: rgb(217, 0, 7);"));

        horizontalLayout_2->addWidget(toggleAnonsend);

        anonsendReset = new QPushButton(verticalLayoutWidget);
        anonsendReset->setObjectName(QStringLiteral("anonsendReset"));
        sizePolicy1.setHeightForWidth(anonsendReset->sizePolicy().hasHeightForWidth());
        anonsendReset->setSizePolicy(sizePolicy1);
        anonsendReset->setAutoFillBackground(false);
        anonsendReset->setStyleSheet(QStringLiteral("color: rgb(217, 0, 7);"));

        horizontalLayout_2->addWidget(anonsendReset);

        anonsendAuto = new QPushButton(verticalLayoutWidget);
        anonsendAuto->setObjectName(QStringLiteral("anonsendAuto"));
        sizePolicy1.setHeightForWidth(anonsendAuto->sizePolicy().hasHeightForWidth());
        anonsendAuto->setSizePolicy(sizePolicy1);
        anonsendAuto->setStyleSheet(QStringLiteral("color: rgb(217, 0, 7);"));

        horizontalLayout_2->addWidget(anonsendAuto);


        verticalLayout_5->addLayout(horizontalLayout_2);


        horizontalLayout->addWidget(frameAnonsend);
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        anonsendEnabled->setText(QApplication::translate("OverviewPage", "Enabled/Disabled", 0));
        label_7->setText(QApplication::translate("OverviewPage", "Completion:", 0));
        labelAnonymizedText->setText(QApplication::translate("OverviewPage", "Anonsend Balance:", 0));
        labelAnonymized->setText(QApplication::translate("OverviewPage", "0 NAV", 0));
        label_8->setText(QApplication::translate("OverviewPage", "Amount and Rounds:", 0));
        labelAmountRounds->setText(QApplication::translate("OverviewPage", "0 NAV / 0 Rounds", 0));
        label_9->setText(QApplication::translate("OverviewPage", "Submitted Denom:", 0));
#ifndef QT_NO_STATUSTIP
        labelSubmittedDenom->setStatusTip(QApplication::translate("OverviewPage", "The denominations you submitted to the Rush Node. To mix, other users must submit the exact same denominations.", 0));
#endif // QT_NO_STATUSTIP
        labelSubmittedDenom->setText(QApplication::translate("OverviewPage", "n/a", 0));
        anonsendStatus->setText(QApplication::translate("OverviewPage", "(Last Message)", 0));
        toggleAnonsend->setText(QApplication::translate("OverviewPage", "Start/Stop", 0));
#ifndef QT_NO_TOOLTIP
        anonsendReset->setToolTip(QApplication::translate("OverviewPage", "Reset the current status of Anonsend (can interrupt Anonsend if it's in the process of Mixing, which can cost you money!)", 0));
#endif // QT_NO_TOOLTIP
        anonsendReset->setText(QApplication::translate("OverviewPage", "Reset", 0));
#ifndef QT_NO_TOOLTIP
        anonsendAuto->setToolTip(QApplication::translate("OverviewPage", "Try to manually submit a Anonsend request.", 0));
#endif // QT_NO_TOOLTIP
        anonsendAuto->setText(QApplication::translate("OverviewPage", "Try Mix", 0));
