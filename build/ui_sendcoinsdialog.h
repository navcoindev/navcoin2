...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        anonSend = new QCheckBox(SendCoinsDialog);
        anonSend->setObjectName(QStringLiteral("anonSend"));

        verticalLayout->addWidget(anonSend);
...
"}"));
        QIcon icon;
        icon.addFile(QStringLiteral(":/icons/send-white"), QSize(), QIcon::Normal, QIcon::Off);
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
        ...
        anonSend->setText(QApplication::translate("SendCoinsDialog", "Send NAV Anonymously", 0));
