...
"}"));
        QIcon icon;
        icon.addFile(QStringLiteral(":/icons/close-white"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        newButton->setStyleSheet(QLatin1String("QPushButton {\n"
"	color: #FFFFFF; \n"
"	font-weight:bold; \n"
"	margin: 1px 0; \n"
"	padding: 5px 10px; \n"
...
"}"));
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/icons/plus-white"), QSize(), QIcon::Normal, QIcon::Off);
...
"}"));
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/icons/send-white"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        copyFromAddressButton->setStyleSheet(QLatin1String("QPushButton {\n"
"	color: #FFFFFF; \n"
"	font-weight:bold; \n"
"	margin: 1px 0; \n"
"	padding: 5px 10px; \n"
...
"}"));
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/icons/copy-white"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        copyToAddressButton->setStyleSheet(QLatin1String("QPushButton {\n"
"	color: #FFFFFF; \n"
"	font-weight:bold; \n"
"	margin: 1px 0; \n"
"	padding: 5px 10px; \n"
...
"}"));
        QIcon icon4;
        icon4.addFile(QStringLiteral(":/icons/minus-white"), QSize(), QIcon::Normal, QIcon::Off);
...
#ifndef QT_NO_TOOLTIP
        sendButton->setToolTip(QApplication::translate("MessagePage", "Sign a message to prove you own a NavCoin address", 0));
#endif // QT_NO_TOOLTIP
