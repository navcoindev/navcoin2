...
public:
    ...
    void setupUi(QDialog *SendMessagesDialog)
    {
        ...
        SendMessagesDialog->setStyleSheet(QStringLiteral("#SendMessagesDialog { background-image: url(:/images/background) }"));
        ...
        addressFromLabel->setStyleSheet(QStringLiteral("color: #222222;"));
...
"}"));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 830, 287));
...
"}"));
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/icons/plus-white"), QSize(), QIcon::Normal, QIcon::Off);
...
"}"));
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/icons/minus-white"), QSize(), QIcon::Normal, QIcon::Off);
...
"}"));
        QIcon icon4;
        icon4.addFile(QStringLiteral(":/icons/send-white"), QSize(), QIcon::Normal, QIcon::Off);
...
"}"));
        QIcon icon5;
        icon5.addFile(QStringLiteral(":/icons/close-white"), QSize(), QIcon::Normal, QIcon::Off);
