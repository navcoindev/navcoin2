...
# Project:  NavCoin2-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -spec linux-g++-64 CONFIG+=debug USE_UPNP=1 -o Makefile NavCoin2-qt.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DENABLE_WALLET -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DQT_DISABLE_DEPRECATED_BEFORE=0 -DBOOST_VARIANT_USE_RELAXED_GET_BY_DEFAULT -DUSE_DBUS -DHAVE_BUILD_INFO -DUSE_UPNP=1 -DMINIUPNP_STATICLIB -DSTATICLIB -DLINUX -DQT_PRINTSUPPORT_LIB -DQT_WIDGETS_LIB -DQT_DBUS_LIB -DQT_NETWORK_LIB -DQT_GUI_LIB -DQT_CORE_LIB
CFLAGS        = -m64 -pipe -g -D_REENTRANT -Wall -W -fPIE $(DEFINES)
CXXFLAGS      = -m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -D_FORTIFY_SOURCE=2 -g -D_REENTRANT -fdiagnostics-show-option -Wall -Wextra -Wno-ignored-qualifiers -Wformat -Wformat-security -Wno-unused-parameter -Wstack-protector -Wno-unused-variable -fpermissive -Wno-unused-local-typedefs -fPIE $(DEFINES)
...
LIBS          = $(SUBLIBS) -L/usr/X11R6/lib64 /home/craig/projects/navcoin2/src/leveldb/libleveldb.a /home/craig/projects/navcoin2/src/leveldb/libmemenv.a /home/craig/projects/navcoin2/src/secp256k1/src/libsecp256k1_la-secp256k1.o -lminiupnpc -lssl -lcrypto -ldb_cxx -lgmp -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lrt -ldl -lQt5PrintSupport -L/usr/lib/x86_64-linux-gnu -lQt5Widgets -lQt5DBus -lQt5Network -lQt5Gui -lQt5Core -lpthread -lGL 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = src/txdb-leveldb.cpp \
		...
		build/moc_inodemanager.cpp \
		build/moc_addeditrushnode.cpp \
		build/moc_rushnodeconfigdialog.cpp \
...
OBJECTS       = build/txdb-leveldb.o \
		...
		build/inodemanager.o \
		build/addeditrushnode.o \
		build/rushnodeconfigdialog.o \
		build/qcustomplot.o \
		build/smessage.o \
		build/messagepage.o \
		...
		build/moc_inodemanager.o \
		build/moc_addeditrushnode.o \
		build/moc_rushnodeconfigdialog.o \
...
$(TARGET): /home/craig/projects/navcoin2/src/leveldb/libleveldb.a /home/craig/projects/navcoin2/src/secp256k1/src/libsecp256k1_la-secp256k1.o /home/craig/projects/navcoin2/build/build.h build/ui_coincontroldialog.h build/ui_sendcoinsdialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_optionsdialog.h build/ui_anonsendconfig.h build/ui_inodemanager.h build/ui_addeditrushnode.h build/ui_rushnodeconfigdialog.h build/ui_messagepage.h build/ui_sendmessagesentry.h build/ui_sendmessagesdialog.h build/ui_blockbrowser.h build/ui_tradingdialog.h build/ui_stakereportdialog.h build/ui_mrichtextedit.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: NavCoin2-qt.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -spec linux-g++-64 CONFIG+=debug USE_UPNP=1 -o Makefile NavCoin2-qt.pro
...
dist: 
	@test -d build/navcoin-qt3.5.0.0 || mkdir -p build/navcoin-qt3.5.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/navcoin-qt3.5.0.0/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_af_ZA.ts src/qt/locale/bitcoin_ar.ts src/qt/locale/bitcoin_be_BY.ts src/qt/locale/bitcoin_bg.ts src/qt/locale/bitcoin_bs.ts src/qt/locale/bitcoin_ca.ts src/qt/locale/bitcoin_ca@valencia.ts src/qt/locale/bitcoin_ca_ES.ts src/qt/locale/bitcoin_cs.ts src/qt/locale/bitcoin_cy.ts src/qt/locale/bitcoin_da.ts src/qt/locale/bitcoin_de.ts src/qt/locale/bitcoin_el_GR.ts src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_eo.ts src/qt/locale/bitcoin_es.ts src/qt/locale/bitcoin_es_CL.ts src/qt/locale/bitcoin_es_DO.ts src/qt/locale/bitcoin_es_MX.ts src/qt/locale/bitcoin_es_UY.ts src/qt/locale/bitcoin_et.ts src/qt/locale/bitcoin_eu_ES.ts src/qt/locale/bitcoin_fa.ts src/qt/locale/bitcoin_fa_IR.ts src/qt/locale/bitcoin_fi.ts src/qt/locale/bitcoin_fr.ts src/qt/locale/bitcoin_fr_CA.ts src/qt/locale/bitcoin_gl.ts src/qt/locale/bitcoin_he.ts src/qt/locale/bitcoin_hi_IN.ts src/qt/locale/bitcoin_hr.ts src/qt/locale/bitcoin_hu.ts src/qt/locale/bitcoin_id_ID.ts src/qt/locale/bitcoin_it.ts src/qt/locale/bitcoin_ja.ts src/qt/locale/bitcoin_ka.ts src/qt/locale/bitcoin_kk_KZ.ts src/qt/locale/bitcoin_ko_KR.ts src/qt/locale/bitcoin_ky.ts src/qt/locale/bitcoin_la.ts src/qt/locale/bitcoin_lt.ts src/qt/locale/bitcoin_lv_LV.ts src/qt/locale/bitcoin_ms_MY.ts src/qt/locale/bitcoin_nb.ts src/qt/locale/bitcoin_nl.ts src/qt/locale/bitcoin_pam.ts src/qt/locale/bitcoin_pl.ts src/qt/locale/bitcoin_pt_BR.ts src/qt/locale/bitcoin_pt_PT.ts src/qt/locale/bitcoin_ro_RO.ts src/qt/locale/bitcoin_ru.ts src/qt/locale/bitcoin_sah.ts src/qt/locale/bitcoin_sk.ts src/qt/locale/bitcoin_sl_SI.ts src/qt/locale/bitcoin_sq.ts src/qt/locale/bitcoin_sr.ts src/qt/locale/bitcoin_sv.ts src/qt/locale/bitcoin_th_TH.ts src/qt/locale/bitcoin_tr.ts src/qt/locale/bitcoin_uk.ts src/qt/locale/bitcoin_ur_PK.ts src/qt/locale/bitcoin_vi.ts src/qt/locale/bitcoin_vi_VN.ts src/qt/locale/bitcoin_zh_CN.ts src/qt/locale/bitcoin_zh_TW.ts build/navcoin-qt3.5.0.0/ && $(COPY_FILE) --parents src/qt/bitcoin.qrc build/navcoin-qt3.5.0.0/ && $(COPY_FILE) --parents src/qt/bitcoingui.h src/qt/transactiontablemodel.h src/qt/addresstablemodel.h src/qt/optionsdialog.h src/qt/coincontroldialog.h src/qt/coincontroltreewidget.h src/qt/sendcoinsdialog.h src/qt/addressbookpage.h src/qt/signverifymessagedialog.h src/qt/aboutdialog.h src/qt/editaddressdialog.h src/qt/bitcoinaddressvalidator.h src/alert.h src/addrman.h src/base58.h src/bignum.h src/chainparams.h src/chainparamsseeds.h src/checkpoints.h src/compat.h src/coincontrol.h src/sync.h src/util.h src/hash.h src/uint256.h src/kernel.h src/pbkdf2.h src/serialize.h src/core.h src/main.h src/miner.h src/net.h src/key.h src/eckey.h src/db.h src/txdb.h src/txmempool.h src/walletdb.h src/script.h src/scrypt.h src/init.h src/mruset.h src/json/json_spirit_writer_template.h src/json/json_spirit_writer.h src/json/json_spirit_value.h src/json/json_spirit_utils.h src/json/json_spirit_stream_reader.h src/json/json_spirit_reader_template.h src/json/json_spirit_reader.h src/json/json_spirit_error_position.h src/json/json_spirit.h src/qt/clientmodel.h src/qt/guiutil.h src/qt/transactionrecord.h src/qt/guiconstants.h src/qt/optionsmodel.h src/qt/monitoreddatamapper.h src/qt/trafficgraphwidget.h src/qt/transactiondesc.h src/qt/transactiondescdialog.h src/qt/bitcoinamountfield.h src/wallet.h src/keystore.h src/qt/transactionfilterproxy.h src/qt/transactionview.h src/qt/walletmodel.h src/rpcclient.h src/rpcprotocol.h src/rpcserver.h src/timedata.h src/qt/overviewpage.h src/qt/csvmodelwriter.h src/crypter.h src/qt/sendcoinsentry.h src/qt/qvalidatedlineedit.h src/qt/bitcoinunits.h src/qt/qvaluecombobox.h src/qt/askpassphrasedialog.h src/protocol.h src/qt/notificator.h src/qt/paymentserver.h src/allocators.h src/ui_interface.h src/qt/rpcconsole.h src/version.h src/netbase.h src/clientversion.h src/threadsafety.h src/tinyformat.h src/secret.h src/qt/flowlayout.h src/qt/anonsendconfig.h src/inode.h src/anonsend.h src/tesseractx.h src/activeinode.h src/hub.h src/crypto/common.h src/crypto/hmac_sha256.h src/crypto/hmac_sha512.h src/crypto/rfc6979_hmac_sha256.h src/crypto/ripemd160.h src/crypto/sha1.h src/crypto/sha256.h src/crypto/sha512.h src/eccryptoverify.h src/qt/inodemanager.h src/qt/addeditrushnode.h src/qt/rushnodeconfigdialog.h src/qt/qcustomplot.h src/smessage.h src/qt/messagepage.h src/qt/messagemodel.h src/qt/sendmessagesdialog.h src/qt/sendmessagesentry.h src/qt/blockbrowser.h src/qt/plugins/mrichtexteditor/mrichtextedit.h src/qt/qvalidatedtextedit.h src/qt/tradingdialog.h src/qt/stakereportdialog.h src/sph_skein.h src/sph_keccak.h src/sph_jh.h src/sph_groestl.h src/sph_bmw.h src/sph_types.h src/sph_luffa.h src/sph_cubehash.h src/sph_echo.h src/sph_shavite.h src/sph_simd.h src/sph_fugue.h src/sph_hamsi.h src/sph_types.h build/navcoin-qt3.5.0.0/ && $(COPY_FILE) --parents src/txdb-leveldb.cpp src/qt/bitcoin.cpp src/qt/bitcoingui.cpp src/qt/transactiontablemodel.cpp src/qt/addresstablemodel.cpp src/qt/optionsdialog.cpp src/qt/sendcoinsdialog.cpp src/qt/coincontroldialog.cpp src/qt/coincontroltreewidget.cpp src/qt/addressbookpage.cpp src/qt/signverifymessagedialog.cpp src/qt/aboutdialog.cpp src/qt/editaddressdialog.cpp src/qt/bitcoinaddressvalidator.cpp src/alert.cpp src/chainparams.cpp src/version.cpp src/sync.cpp src/txmempool.cpp src/util.cpp src/hash.cpp src/netbase.cpp src/key.cpp src/eckey.cpp src/script.cpp src/scrypt.cpp src/core.cpp src/main.cpp src/miner.cpp src/init.cpp src/net.cpp src/checkpoints.cpp src/addrman.cpp src/db.cpp src/walletdb.cpp src/qt/clientmodel.cpp src/qt/guiutil.cpp src/qt/transactionrecord.cpp src/qt/optionsmodel.cpp src/qt/monitoreddatamapper.cpp src/qt/trafficgraphwidget.cpp src/qt/transactiondesc.cpp src/qt/transactiondescdialog.cpp src/qt/bitcoinstrings.cpp src/qt/bitcoinamountfield.cpp src/wallet.cpp src/keystore.cpp src/qt/transactionfilterproxy.cpp src/qt/transactionview.cpp src/qt/walletmodel.cpp src/rpcclient.cpp src/rpcprotocol.cpp src/rpcserver.cpp src/rpcdump.cpp src/rpcmisc.cpp src/rpcnet.cpp src/rpcmining.cpp src/rpcwallet.cpp src/rpcblockchain.cpp src/rpcrawtransaction.cpp src/timedata.cpp src/qt/overviewpage.cpp src/qt/csvmodelwriter.cpp src/crypter.cpp src/qt/sendcoinsentry.cpp src/qt/qvalidatedlineedit.cpp src/qt/bitcoinunits.cpp src/qt/qvaluecombobox.cpp src/qt/askpassphrasedialog.cpp src/protocol.cpp src/qt/notificator.cpp src/qt/paymentserver.cpp src/qt/rpcconsole.cpp src/noui.cpp src/kernel.cpp src/scrypt-arm.S src/scrypt-x86.S src/scrypt-x86_64.S src/pbkdf2.cpp src/secret.cpp src/qt/flowlayout.cpp src/qt/anonsendconfig.cpp src/inode.cpp src/anonsend.cpp src/rpcanonsend.cpp src/tesseractx.cpp src/activeinode.cpp src/hub.cpp src/inodeconfig.cpp src/crypto/hmac_sha256.cpp src/crypto/hmac_sha512.cpp src/crypto/rfc6979_hmac_sha256.cpp src/crypto/ripemd160.cpp src/crypto/sha1.cpp src/crypto/sha256.cpp src/crypto/sha512.cpp src/eccryptoverify.cpp src/qt/inodemanager.cpp src/qt/addeditrushnode.cpp src/qt/rushnodeconfigdialog.cpp src/qt/qcustomplot.cpp src/smessage.cpp src/qt/messagepage.cpp src/qt/messagemodel.cpp src/qt/sendmessagesdialog.cpp src/qt/sendmessagesentry.cpp src/qt/blockbrowser.cpp src/qt/qvalidatedtextedit.cpp src/qt/plugins/mrichtexteditor/mrichtextedit.cpp src/qt/tradingdialog.cpp src/qt/stakereportdialog.cpp src/rpcsmessage.cpp src/blake.c src/bmw.c src/groestl.c src/jh.c src/keccak.c src/skein.c src/luffa.c src/cubehash.c src/shavite.c src/echo.c src/fugue.c src/hamsi.c src/simd.c build/navcoin-qt3.5.0.0/ && $(COPY_FILE) --parents src/qt/forms/coincontroldialog.ui src/qt/forms/sendcoinsdialog.ui src/qt/forms/addressbookpage.ui src/qt/forms/signverifymessagedialog.ui src/qt/forms/aboutdialog.ui src/qt/forms/editaddressdialog.ui src/qt/forms/transactiondescdialog.ui src/qt/forms/overviewpage.ui src/qt/forms/sendcoinsentry.ui src/qt/forms/askpassphrasedialog.ui src/qt/forms/rpcconsole.ui src/qt/forms/optionsdialog.ui src/qt/forms/anonsendconfig.ui src/qt/forms/inodemanager.ui src/qt/forms/addeditrushnode.ui src/qt/forms/rushnodeconfigdialog.ui src/qt/forms/messagepage.ui src/qt/forms/sendmessagesentry.ui src/qt/forms/sendmessagesdialog.ui src/qt/forms/blockbrowser.ui src/qt/forms/tradingdialog.ui src/qt/forms/stakereportdialog.ui src/qt/plugins/mrichtexteditor/mrichtextedit.ui build/navcoin-qt3.5.0.0/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_af_ZA.ts src/qt/locale/bitcoin_ar.ts src/qt/locale/bitcoin_be_BY.ts src/qt/locale/bitcoin_bg.ts src/qt/locale/bitcoin_bs.ts src/qt/locale/bitcoin_ca.ts src/qt/locale/bitcoin_ca@valencia.ts src/qt/locale/bitcoin_ca_ES.ts src/qt/locale/bitcoin_cs.ts src/qt/locale/bitcoin_cy.ts src/qt/locale/bitcoin_da.ts src/qt/locale/bitcoin_de.ts src/qt/locale/bitcoin_el_GR.ts src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_eo.ts src/qt/locale/bitcoin_es.ts src/qt/locale/bitcoin_es_CL.ts src/qt/locale/bitcoin_es_DO.ts src/qt/locale/bitcoin_es_MX.ts src/qt/locale/bitcoin_es_UY.ts src/qt/locale/bitcoin_et.ts src/qt/locale/bitcoin_eu_ES.ts src/qt/locale/bitcoin_fa.ts src/qt/locale/bitcoin_fa_IR.ts src/qt/locale/bitcoin_fi.ts src/qt/locale/bitcoin_fr.ts src/qt/locale/bitcoin_fr_CA.ts src/qt/locale/bitcoin_gl.ts src/qt/locale/bitcoin_he.ts src/qt/locale/bitcoin_hi_IN.ts src/qt/locale/bitcoin_hr.ts src/qt/locale/bitcoin_hu.ts src/qt/locale/bitcoin_id_ID.ts src/qt/locale/bitcoin_it.ts src/qt/locale/bitcoin_ja.ts src/qt/locale/bitcoin_ka.ts src/qt/locale/bitcoin_kk_KZ.ts src/qt/locale/bitcoin_ko_KR.ts src/qt/locale/bitcoin_ky.ts src/qt/locale/bitcoin_la.ts src/qt/locale/bitcoin_lt.ts src/qt/locale/bitcoin_lv_LV.ts src/qt/locale/bitcoin_ms_MY.ts src/qt/locale/bitcoin_nb.ts src/qt/locale/bitcoin_nl.ts src/qt/locale/bitcoin_pam.ts src/qt/locale/bitcoin_pl.ts src/qt/locale/bitcoin_pt_BR.ts src/qt/locale/bitcoin_pt_PT.ts src/qt/locale/bitcoin_ro_RO.ts src/qt/locale/bitcoin_ru.ts src/qt/locale/bitcoin_sah.ts src/qt/locale/bitcoin_sk.ts src/qt/locale/bitcoin_sl_SI.ts src/qt/locale/bitcoin_sq.ts src/qt/locale/bitcoin_sr.ts src/qt/locale/bitcoin_sv.ts src/qt/locale/bitcoin_th_TH.ts src/qt/locale/bitcoin_tr.ts src/qt/locale/bitcoin_uk.ts src/qt/locale/bitcoin_ur_PK.ts src/qt/locale/bitcoin_vi.ts src/qt/locale/bitcoin_vi_VN.ts src/qt/locale/bitcoin_zh_CN.ts src/qt/locale/bitcoin_zh_TW.ts build/navcoin-qt3.5.0.0/ && (cd `dirname build/navcoin-qt3.5.0.0` && $(TAR) navcoin-qt3.5.0.0.tar navcoin-qt3.5.0.0 && $(COMPRESS) navcoin-qt3.5.0.0.tar) && $(MOVE) `dirname build/navcoin-qt3.5.0.0`/navcoin-qt3.5.0.0.tar.gz . && $(DEL_FILE) -r build/navcoin-qt3.5.0.0


clean:compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /home/craig/projects/navcoin2/src/leveldb/libleveldb.a; cd /home/craig/projects/navcoin2/src/leveldb ; $(MAKE) clean /home/craig/projects/navcoin2/src/secp256k1/src/libsecp256k1_la-secp256k1.o; cd /home/craig/projects/navcoin2/src/secp256k1; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/home/craig/projects/navcoin2/src/leveldb/libleveldb.a: FORCE
	cd /home/craig/projects/navcoin2/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/home/craig/projects/navcoin2/src/secp256k1/src/libsecp256k1_la-secp256k1.o: FORCE
	cd /home/craig/projects/navcoin2/src/secp256k1 && ./autogen.sh && ./configure --enable-module-recovery && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -D_FORTIFY_SOURCE=2 -O2"

/home/craig/projects/navcoin2/build/build.h: FORCE
	cd /home/craig/projects/navcoin2; /bin/sh share/genbuild.sh /home/craig/projects/navcoin2/build/build.h
...
qrc_bitcoin.cpp: src/qt/bitcoin.qrc \
		...
		src/qt/res/icons/receive-black.png \
		src/qt/res/icons/dashboard-white.png \
		src/qt/res/icons/paste-white.png \
		src/qt/res/icons/key.png \
		src/qt/res/icons/transaction_conflicted.png \
		src/qt/res/icons/chart-black.png \
		src/qt/res/icons/question-black.png \
		src/qt/res/icons/user-black.png \
		src/qt/res/icons/tx_inout.png \
		src/qt/res/icons/close-black.png \
		src/qt/res/icons/copy-black.png \
		src/qt/res/icons/send-white.png \
		src/qt/res/icons/list-black.png \
		src/qt/res/icons/cube-black.png \
		src/qt/res/icons/add.png \
		src/qt/res/icons/minus-black.png \
		src/qt/res/icons/quit.png \
		src/qt/res/icons/overview.png \
		src/qt/res/icons/plus-white.png \
		src/qt/res/icons/export.png \
		src/qt/res/icons/receive-white.png \
		src/qt/res/icons/transaction0.png \
		src/qt/res/icons/clock1.png \
		src/qt/res/icons/cloud-black.png \
		...
		src/qt/res/icons/question-white.png \
		src/qt/res/icons/chart-white.png \
		src/qt/res/icons/user-white.png \
		src/qt/res/icons/tx_input.png \
		src/qt/res/icons/edit-black.png \
		src/qt/res/icons/mail-black.png \
		src/qt/res/icons/qrcode.png \
		src/qt/res/icons/connect0_16.png \
		src/qt/res/icons/connect1_16.png \
		src/qt/res/icons/navcoin-80.png \
		src/qt/res/icons/close-white.png \
		src/qt/res/icons/connect2_16.png \
		src/qt/res/icons/connect3_16.png \
		src/qt/res/icons/connect4_16.png \
		src/qt/res/icons/copy-white.png \
		src/qt/res/icons/cube-white.png \
		src/qt/res/icons/lock_open.png \
		src/qt/res/icons/list-white.png \
		src/qt/res/icons/history.png \
		src/qt/res/icons/edit.png \
		src/qt/res/icons/dashboard-black.png \
		src/qt/res/icons/lock_closed.png \
		src/qt/res/icons/minus-white.png \
		src/qt/res/icons/paste-black.png \
		src/qt/res/icons/transaction2.png \
		src/qt/res/icons/address-book.png \
		src/qt/res/icons/staking_off.png \
		src/qt/res/icons/cloud-white.png \
		src/qt/res/icons/configure.png \
		src/qt/res/icons/onion.png \
		src/qt/res/icons/staking_on.png \
		src/qt/res/icons/navcoin-16.png \
		src/qt/res/icons/send.png \
		src/qt/res/icons/editcopy.png \
		src/qt/res/icons/tx_output.png \
		src/qt/res/icons/edit-white.png \
		src/qt/res/icons/send-black.png \
		src/qt/res/icons/mail-white.png \
		src/qt/res/icons/remove.png \
		src/qt/res/icons/filesave.png \
		src/qt/res/icons/navcoin-16.png \
		src/qt/res/icons/tx_mined.png \
		src/qt/res/icons/debugwindow.png \
		src/qt/res/icons/plus-black.png \
...
build/moc_anonsendconfig.cpp: /usr/include/qt5/QtWidgets/QDialog \
		/usr/include/qt5/QtWidgets/qdialog.h \
		/usr/include/qt5/QtWidgets/qwidget.h \
		/usr/include/qt5/QtGui/qwindowdefs.h \
		/usr/include/qt5/QtCore/qglobal.h \
	...
	/usr/lib/x86_64-linux-gnu/qt5/bin/moc $(DEFINES) $(INCPATH) -I/usr/include/c++/4.8 -I/usr/include/x86_64-linux-gnu/c++/4.8 -I/usr/include/c++/4.8/backward -I/usr/lib/gcc/x86_64-linux-gnu/4.8/include -I/usr/local/include -I/usr/lib/gcc/x86_64-linux-gnu/4.8/include-fixed -I/usr/include/x86_64-linux-gnu -I/usr/include src/qt/anonsendconfig.h -o build/moc_anonsendconfig.cpp

build/moc_inodemanager.cpp: src/util.h \
		src/serialize.h \
		src/allocators.h \
		src/version.h \
		src/clientversion.h \
	...
	/usr/lib/x86_64-linux-gnu/qt5/bin/moc $(DEFINES) $(INCPATH) -I/usr/include/c++/4.8 -I/usr/include/x86_64-linux-gnu/c++/4.8 -I/usr/include/c++/4.8/backward -I/usr/lib/gcc/x86_64-linux-gnu/4.8/include -I/usr/local/include -I/usr/lib/gcc/x86_64-linux-gnu/4.8/include-fixed -I/usr/include/x86_64-linux-gnu -I/usr/include src/qt/inodemanager.h -o build/moc_inodemanager.cpp

build/moc_addeditrushnode.cpp: /usr/include/qt5/QtWidgets/QDialog \
		/usr/include/qt5/QtWidgets/qdialog.h \
		/usr/include/qt5/QtWidgets/qwidget.h \
		/usr/include/qt5/QtGui/qwindowdefs.h \
		/usr/include/qt5/QtCore/qglobal.h \
	...
	/usr/lib/x86_64-linux-gnu/qt5/bin/moc $(DEFINES) $(INCPATH) -I/usr/include/c++/4.8 -I/usr/include/x86_64-linux-gnu/c++/4.8 -I/usr/include/c++/4.8/backward -I/usr/lib/gcc/x86_64-linux-gnu/4.8/include -I/usr/local/include -I/usr/lib/gcc/x86_64-linux-gnu/4.8/include-fixed -I/usr/include/x86_64-linux-gnu -I/usr/include src/qt/addeditrushnode.h -o build/moc_addeditrushnode.cpp

build/moc_rushnodeconfigdialog.cpp: /usr/include/qt5/QtWidgets/QDialog \
		/usr/include/qt5/QtWidgets/qdialog.h \
		/usr/include/qt5/QtWidgets/qwidget.h \
		/usr/include/qt5/QtGui/qwindowdefs.h \
		/usr/include/qt5/QtCore/qglobal.h \
	...
	/usr/lib/x86_64-linux-gnu/qt5/bin/moc $(DEFINES) $(INCPATH) -I/usr/include/c++/4.8 -I/usr/include/x86_64-linux-gnu/c++/4.8 -I/usr/include/c++/4.8/backward -I/usr/lib/gcc/x86_64-linux-gnu/4.8/include -I/usr/local/include -I/usr/lib/gcc/x86_64-linux-gnu/4.8/include-fixed -I/usr/include/x86_64-linux-gnu -I/usr/include src/qt/rushnodeconfigdialog.h -o build/moc_rushnodeconfigdialog.cpp
...
build/ui_anonsendconfig.h: src/qt/forms/anonsendconfig.ui
	/usr/lib/x86_64-linux-gnu/qt5/bin/uic src/qt/forms/anonsendconfig.ui -o build/ui_anonsendconfig.h

build/ui_inodemanager.h: src/qt/forms/inodemanager.ui
	/usr/lib/x86_64-linux-gnu/qt5/bin/uic src/qt/forms/inodemanager.ui -o build/ui_inodemanager.h

build/ui_addeditrushnode.h: src/qt/forms/addeditrushnode.ui
	/usr/lib/x86_64-linux-gnu/qt5/bin/uic src/qt/forms/addeditrushnode.ui -o build/ui_addeditrushnode.h

build/ui_rushnodeconfigdialog.h: src/qt/forms/rushnodeconfigdialog.ui
	/usr/lib/x86_64-linux-gnu/qt5/bin/uic src/qt/forms/rushnodeconfigdialog.ui -o build/ui_rushnodeconfigdialog.h
...
build/secret.o: src/secret.cpp src/secret.h \
		src/util.h \
		src/serialize.h \
		src/allocators.h \
		src/version.h \
		...
		src/sync.h \
		src/threadsafety.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/secret.o src/secret.cpp
...
build/inode.o: src/inode.cpp src/inode.h \
		src/uint256.h \
		src/sync.h \
		src/threadsafety.h \
		src/net.h \
		...
		src/ui_interface.h \
		src/anonsend.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/inode.o src/inode.cpp
...
build/tesseractx.o: src/tesseractx.cpp src/uint256.h \
		src/sync.h \
		src/threadsafety.h \
		src/net.h \
		src/mruset.h \
		...
		src/anonsend.h \
		src/hub.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/tesseractx.o src/tesseractx.cpp

build/activeinode.o: src/activeinode.cpp src/protocol.h \
		src/chainparams.h \
		src/bignum.h \
		src/serialize.h \
		src/allocators.h \
		...
		src/inode.h \
		src/base58.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/activeinode.o src/activeinode.cpp

build/hub.o: src/hub.cpp src/bignum.h \
		src/serialize.h \
		src/allocators.h \
		src/version.h \
		src/clientversion.h \
		...
		src/crypter.h \
		src/ui_interface.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/hub.o src/hub.cpp

build/inodeconfig.o: src/inodeconfig.cpp src/net.h \
		src/mruset.h \
		src/netbase.h \
		src/serialize.h \
		src/allocators.h \
		...
		src/secret.h \
		src/inodeconfig.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/inodeconfig.o src/inodeconfig.cpp
...
build/inodemanager.o: src/qt/inodemanager.cpp src/qt/inodemanager.h \
		src/util.h \
		src/serialize.h \
		src/allocators.h \
		src/version.h \
		...
		/usr/include/qt5/QtWidgets/QMessageBox \
		/usr/include/qt5/QtWidgets/qmessagebox.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/inodemanager.o src/qt/inodemanager.cpp

build/addeditrushnode.o: src/qt/addeditrushnode.cpp src/qt/addeditrushnode.h \
		/usr/include/qt5/QtWidgets/QDialog \
		/usr/include/qt5/QtWidgets/qdialog.h \
		/usr/include/qt5/QtWidgets/qwidget.h \
		/usr/include/qt5/QtGui/qwindowdefs.h \
		...
		/usr/include/qt5/QtWidgets/QMessageBox \
		/usr/include/qt5/QtWidgets/qmessagebox.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/addeditrushnode.o src/qt/addeditrushnode.cpp

build/rushnodeconfigdialog.o: src/qt/rushnodeconfigdialog.cpp src/qt/rushnodeconfigdialog.h \
		/usr/include/qt5/QtWidgets/QDialog \
		/usr/include/qt5/QtWidgets/qdialog.h \
		/usr/include/qt5/QtWidgets/qwidget.h \
		/usr/include/qt5/QtGui/qwindowdefs.h \
		...
		/usr/include/qt5/QtGui/qvector2d.h \
		/usr/include/qt5/QtGui/qtouchdevice.h \
		build/ui_rushnodeconfigdialog.h \
		/usr/include/qt5/QtCore/QModelIndex \
		/usr/include/qt5/QtCore/qabstractitemmodel.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/rushnodeconfigdialog.o src/qt/rushnodeconfigdialog.cpp
...
build/moc_inodemanager.o: build/moc_inodemanager.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_inodemanager.o build/moc_inodemanager.cpp

build/moc_addeditrushnode.o: build/moc_addeditrushnode.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_addeditrushnode.o build/moc_addeditrushnode.cpp

build/moc_rushnodeconfigdialog.o: build/moc_rushnodeconfigdialog.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_rushnodeconfigdialog.o build/moc_rushnodeconfigdialog.cpp
