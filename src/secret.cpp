...
const uint8_t secret_version_byte = 0x28;


bool CSecretAddress::SetEncoded(const std::string& encodedAddress)
{
    data_chunk raw;
    ...
    {
        if (fDebug)
            printf("CSecretAddress::SetEncoded DecodeBase58 falied.\n");
        return false;
    };
    ...
    {
        if (fDebug)
            printf("CSecretAddress::SetEncoded verify_checksum falied.\n");
        return false;
    };
    ...
    {
        if (fDebug)
            printf("CSecretAddress::SetEncoded() too few bytes provided.\n");
        return false;
    };
    ...
    if (version != secret_version_byte)
    {
        printf("CSecretAddress::SetEncoded version mismatch 0x%x != 0x%x.\n", version, secret_version_byte);
        return false;
    };
...
std::string CSecretAddress::Encoded() const
{
    // https://wiki.unsystem.net/index.php/AnonWallet/Secret#Address_format
    // [version] [options] [scan_key] [N] ... [Nsigs] [prefix_length] ...
    
    data_chunk raw;
    raw.push_back(secret_version_byte);
...
int SecretSecret(ec_secret& secret, ec_point& pubkey, const ec_point& pkSpend, ec_secret& sharedSOut, ec_point& pkOut)
{
    ...
    */
    ...
    if (!ecgrp)
    {
        printf("SecretSecret(): EC_GROUP_new_by_curve_name failed.\n");
        return 1;
    };
    
    if (!(bnCtx = BN_CTX_new()))
    {
        printf("SecretSecret(): BN_CTX_new failed.\n");
        rv = 1;
        goto End;
    };
    ...
    {
        printf("SecretSecret(): bnEphem BN_bin2bn failed.\n");
        rv = 1;
        goto End;
    };
    ...
    {
        printf("SecretSecret(): bnQ BN_bin2bn failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        printf("SecretSecret(): Q EC_POINT_bn2point failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        printf("SecretSecret(): eQ EC_POINT_mul failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        printf("SecretSecret(): bnOutQ incorrect length.\n");
        rv = 1;
        goto End;
    };
    ...
    {
        printf("SecretSecret(): BN_bin2bn failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        printf("SecretSecret(): C EC_POINT_new failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        printf("SecretSecret(): C EC_POINT_mul failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        printf("SecretSecret(): bnR BN_bin2bn failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        printf("SecretSecret(): R EC_POINT_bn2point failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        printf("SecretSecret(): Rout EC_POINT_new failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        printf("SecretSecret(): Rout EC_POINT_add failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        printf("SecretSecret(): Rout EC_POINT_bn2point failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        printf("SecretSecret(): pkOut incorrect length.\n");
        rv = 1;
        goto End;
    };
...
int SecretSecretSpend(ec_secret& scanSecret, ec_point& ephemPubkey, ec_secret& spendSecret, ec_secret& secretOut)
{
    ...
    */
    ...
    if (!ecgrp)
    {
        printf("SecretSecretSpend(): EC_GROUP_new_by_curve_name failed.\n");
        return 1;
    };
    
    if (!(bnCtx = BN_CTX_new()))
    {
        printf("SecretSecretSpend(): BN_CTX_new failed.\n");
        rv = 1;
        goto End;
    };
    ...
    {
        printf("SecretSecretSpend(): bnScanSecret BN_bin2bn failed.\n");
        rv = 1;
        goto End;
    };
    ...
    {
        printf("SecretSecretSpend(): bnP BN_bin2bn failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        printf("SecretSecretSpend(): P EC_POINT_bn2point failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        printf("SecretSecretSpend(): dP EC_POINT_mul failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        printf("SecretSecretSpend(): bnOutP incorrect length.\n");
        rv = 1;
        goto End;
    };
    ...
    {
        printf("SecretSecretSpend(): BN_bin2bn failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        printf("SecretSecretSpend(): EC_GROUP_get_order failed\n");
        rv = 1;
        goto End;
    };
    ...
    {
        printf("SecretSecretSpend(): bnSpend BN_bin2bn failed.\n");
        rv = 1;
        goto End;
    };
    ...
    {
        printf("SecretSecretSpend(): bnSpend BN_mod_add failed.\n");
        rv = 1;
        goto End;
    };
    ...
    {
        printf("SecretSecretSpend(): bnSpend is zero.\n");
        rv = 1;
        goto End;
    };
    ...
    {
        printf("SecretSecretSpend(): bnSpend incorrect length.\n");
        rv = 1;
        goto End;
    };
...
bool IsSecretAddress(const std::string& encodedAddress)
{
    ...
    if (!DecodeBase58(encodedAddress, raw))
    {
        //printf("IsSecretAddress DecodeBase58 falied.\n");
        return false;
    };
    
    if (!VerifyChecksum(raw))
    {
        //printf("IsSecretAddress verify_checksum falied.\n");
        return false;
    };
    
    if (raw.size() < 1 + 1 + 33 + 1 + 33 + 1 + 1 + 4)
    {
        //printf("IsSecretAddress too few bytes provided.\n");
        return false;
    };
    ...
    if (version != secret_version_byte)
    {
        //printf("IsSecretAddress version mismatch 0x%x != 0x%x.\n", version, secret_version_byte);
        return false;
    };
