...
private slots:
    ...
    void onUpdateKeys_clicked(bool Save=false, bool Load=false);
    ...
    QString BuyNAV(QString OrderType, double Quantity, double Rate);
    QString SellNAV(QString OrderType, double Quantity, double Rate);
