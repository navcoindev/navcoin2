...
public:
    ...
    void setAnonDetails(double min, double max, QString address);
    void setAnonSend(bool anonSend);
    //void setEncryptedAddress(QString encryptedAddress);
    ...
    SendCoinsReturn sendCoins(const QString &dZeel, const QList<SendCoinsRecipient> &recipients, const CCoinControl *coinControl=NULL);
    ...
    public:
        ...
        // Copy operator and constructor to navcoin in the context
