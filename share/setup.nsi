...
!define URL http://www.navcoin.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/navcoin.ico"
...
OutFile navcoin-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/navcoin-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/navcoind.exe
...
Section -post SEC0001
    ...
    #    WriteRegStr HKCR "bitcoin\navcoin\open\command" "" '"$INSTDIR\bitcoin-qt.exe" "$$1"'
SectionEnd
